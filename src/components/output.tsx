...
const triggerExecute = (
    ...
    executeId: string,
    props: StateProps & ExecuteDispatchProps
): void => {
    ...
    return (
        <div className="output-container">
            ...
            <div className="output-bar">
                <div
                    className={`output-btn ${loading ? 'output-btn-loading' : ''}`}
                    onClick={() => {
                        if (!loading && hasAlgrx) {
                ...
                >
                    <FontAwesomeIcon
                        className="output-btn-icon"
                        icon={
                            loading
                                ? faSpinner
                                : props.executeState.running && !props.executeState.paused
                                ? faPause
                                : faPlay
                        }
                        spin={loading}
